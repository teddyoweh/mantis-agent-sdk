...
- **Drive it from a terminal** → [The mantis terminal](terminal.md)
- **See what it's doing, and what it cost** → [The dashboard](dashboard.md)
- **Stand a model up on your own GPU cloud** → [Deploy](deploy.md)
